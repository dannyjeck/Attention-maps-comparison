...
for k=1:length(h)
   ...
   if strcmp(htype,'axes')
      ...
      set(h(k),'FontName','Helvetica') %change font to an editable one
      set(h(k),'FontSize',16);                % 12-pt tick mark labels
%       set(h(k),'FontWeight','bold');        % bold tick mark labels
      ...
      set(get(h(k),'XLabel'),'FontSize',16)        % 14-pt bold labels
%       set(get(h(k),'XLabel'),'FontWeight','bold')
      set(get(h(k),'XLabel'),'FontName','Helvetica') %change font to an editable one
      ...
      set(get(h(k),'YLabel'),'FontSize',16)        % 14-pt bold labels
      set(get(h(k),'YLabel'),'FontName','Helvetica')
%       set(get(h(k),'YLabel'),'FontWeight','bold')
      set(get(h(k),'YLabel'),'VerticalAlignment','baseline')

      set(get(h(k),'ZLabel'),'FontSize',16)        % 14-pt bold labels
      set(get(h(k),'ZLabel'),'FontName','Helvetica')
%       set(get(h(k),'ZLabel'),'FontWeight','bold')
      ...
      set(get(h(k),'Title'),'FontName','Helvetica')
%       set(get(h(k),'Title'),'FontWeight','bold')
   
   elseif strcmp(htype,'text')
      set(h(k),'FontSize',16);                        % 14-pt bold descriptive labels
      set(h(k),'FontName','Helvetica')
